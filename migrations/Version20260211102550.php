 ...
 */
final class Version20260211102550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tbl_connection (id INT AUTO_INCREMENT NOT NULL, weight INT NOT NULL, pmr TINYINT NOT NULL, instruction_a_to_b LONGTEXT NOT NULL, instruction_b_to_a LONGTEXT NOT NULL, image_a_to_b VARCHAR(255) DEFAULT NULL, image_b_to_a VARCHAR(255) DEFAULT NULL, location_a_id INT NOT NULL, location_b_id INT NOT NULL, INDEX IDX_40B439F7BBDAE618 (location_a_id), INDEX IDX_40B439F7A96F49F6 (location_b_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
